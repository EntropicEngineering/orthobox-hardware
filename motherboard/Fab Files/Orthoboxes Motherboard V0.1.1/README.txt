...
5) ENIG Finish
6) 1 oz outer layers
7) Green Solder Mask , Both Sides, Standard Type ,*FULLY TENT VIAS ON BOTH SIDSE* 
...
1) BOM included as motherboard_BOM.xls
2) Pick and Place (XY) included as motherboard_pick_and_place.txt
3) Assembly Drawing as Assembly_Drawings.pdf
4) Turnkey Assembly Required
5) Total Components : 54
6) Total Through Hole Components : 3
7) Total SMD Components : 51
8) Number of Lead-Less Devices : 0 - NONE
9) Unique Number of BOM ITEMS : 33
10) Number of Assembly Sides : 1 (TOP SIDE COMPONENTS LOAD ONLY) 
11) IPC-A-610 - Class2
12) LEAD FREE PROCESSING REQUIRED

Special Assembly Notes:
The wire to board screw header J1 should be placed with the with the holes for wires facing outwards from the board. 
